    ...
    <app-modal>
      <div class="flex flex-col gap-4 text-center">
        ...
        <div class="flex flex-col items-center text-sm text-gray-500">
          ...
          <h5 data-cy="confirm-hero-name" class="mb-1 text-xl font-medium text-gray-500">
            {{ hero.name }}
          </h5>
        </div>

        <div class="flex gap-2 justify-end">
          <app-button data-cy="confirm-hire" type="danger" (click)="onHire(hero)">Yes</app-button>
          <app-button data-cy="unconfirm-hire" type="outline" (click)="hideModal()">No</app-button>
        </div>
      </div>
    </app-modal>
  `,
